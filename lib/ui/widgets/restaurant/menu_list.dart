      ...
      padding: EdgeInsets.zero,
        ...
        return Material(
          child: InkWell(
            ...
            child: ListTile(
              isThreeLine: false,
              leading: FadeInImage.memoryNetwork(placeholder: kTransparentImage,
                  image: 'http://picsum.photos/id/292/300',
              height: 50,
              width: 50,
              fit: BoxFit.cover,),
              title: Row(
                ...
                children: [
                  Expanded(child: Text(
                    widget.menuItems![index].name.toString(),
              ...
              subtitle: Text(
                widget.menuItems![index].description.toString(),
                softWrap: true,
            ...
            child: Column(
              children: [
                ...
                Row(
                  ...
                  children: [
                    IconButton(onPressed: (){}, icon: Icon(Icons.remove,color: Colors.black26,)),
                    Text('1',
                    style: Theme.of(context).textTheme.subtitle2,),
