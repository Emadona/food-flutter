...
import 'package:food/ui/widgets/restaurant/menu_list.dart';
...
class _RestaurantPageState extends State<RestaurantPage> {
  ...
  @override
  void initState() {
    widget.restaurantCubit.getRestaurantMenu(widget.restaurant.id.toString());
    super.initState();
  }
        ...
        child: Stack(
          children: [
            FadeInImage.memoryNetwork(
              ...
              image: widget.restaurant.displayImgUrl.toString(),
              height: 350,
        ...
        child: Column(
          ...
          children: [
            ...
            Expanded(
                child: TabBarView(
              children:
                  menus.map<Widget>((menu) => MenuList(menu.items)).toList(),
            ))
          ],
        ),
      ));
